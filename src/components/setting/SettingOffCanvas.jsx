...
const SettingOffCanvas = memo(() => {
    ...
    return (
        <Fragment>
            ...
            <Offcanvas show={show} onHide={() => setShow(false)} placement={`${themeSchemeDirection === "rtl" ? "start" : "end"}`} className="live-customizer" tabIndex="-1" id="live-customizer" backdrop={false}
                scroll={true}>
                <Offcanvas.Header className="pb-0 justify-content-between">
                    ...
                    <div className="d-flex gap-2 align-items-center">
                        ...
                        >
                            ...
                            <button
                                ...
                                className="btn btn-primary p-2 d-flex align-items-center gap-1" data-copy="settings">
                        ...
                        >
                            <button onClick={resetTheme} className="btn btn-primary btn-icon" data-reset="settings" data-bs-toggle="tooltip"
                        ...
                        <div className="close-icon" data-bs-dismiss="offcanvas" role="button" onClick={() => {
                            setShow(false)
                        }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" className="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
            ...
            {/* ---- Offcanvas Button ---- */}
            <a className="btn btn-fixed-end btn-warning btn-icon btn-setting" id="settingbutton"
                role="button" aria-controls="live-customizer" onClick={(e) => { e.stopPropagation(); setShow(true) }}>
