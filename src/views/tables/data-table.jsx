...
const tableData = [
    ...
    { name: "Garrett Winters", position: "Skin Specialist", office: "Tokyo", age: 63, startdate: "2011/07/25", salary: "$170,750" },
    { name: "Olivia Wilson", position: "Laboratorian", office: "San Francisco", age: 66, startdate: "2009/01/12", salary: "$86,000" },
    { name: "Cedric Kelly", position: "Orthopedics", office: "Edinburgh", age: 22, startdate: "2012/03/29", salary: "$433,060" },
    { name: "Amine Louis", position: "Skin Specialist", office: "Tokyo", age: 33, startdate: "2008/11/28", salary: "$162,700" },
    { name: "Ethan Rodriguez", position: "ENT Specialist", office: "New York", age: 61, startdate: "2012/12/02", salary: "$372,000" },
    { name: "Herrod Chandler", position: "Eye Specialist", office: "San Francisco", age: 59, startdate: "2012/08/06", salary: "$137,500" },
    { name: "Rhona Davidson", position: "ENT Specialist", office: "Tokyo", age: 55, startdate: "2010/10/14", salary: "$327,900" },
    { name: "Colleen Hurst", position: "Fertility Specialist", office: "San Francisco", age: 39, startdate: "2009/09/15", salary: "$205,500" },
    { name: "Sonya Frost", position: "Cardiologist", office: "Edinburgh", age: 23, startdate: "2008/12/13", salary: "$103,600" },
    ...
    { name: "Emily Thompson", position: "Cardiologist", office: "London", age: 41, startdate: "2012/10/13", salary: "$132,000" },
    ...
    { name: "Matthew Anderson", position: "Pediatricians", office: "New York", age: 21, startdate: "2011/12/12", salary: "$106,450" },
    { name: "Doris Wilder", position: "Eye Specialist", office: "Sydney", age: 23, startdate: "2010/09/20", salary: "$85,600" },
    { name: "Alexandra Johnson", position: "Chief Executive Officer (CEO)", office: "London", age: 47, startdate: "2009/10/09", salary: "$1,200,000" },
    { name: "Gavin Joyce", position: "General Checkup", office: "Edinburgh", age: 42, startdate: "2010/12/22", salary: "$92,575" },
    { name: "Jennifer Chang", position: "Regional Director", office: "Singapore", age: 28, startdate: "2010/11/14", salary: "$357,650" },
    { name: "Christopher Martinezr", position: "Cardiologist", office: "San Francisco", age: 28, startdate: "2011/06/07", salary: "$206,850" },
    ...
    { name: "Michelle House", position: "ENT Specialist", office: "Sydney", age: 37, startdate: "2011/06/02", salary: "$95,400" },
    { name: "Suki Burks", position: "General Checkup", office: "London", age: 53, startdate: "2009/10/22", salary: "$114,500" },
    ...
    { name: "Olivia Liang", position: "Dentist", office: "Singapore", age: 64, startdate: "2011/02/03", salary: "$234,500" },
    { name: "Samantha Taylor", position: "Cardiologist", office: "London", age: 38, startdate: "2011/05/03", salary: "$163,500" },
    { name: "Sakura Yamamoto", position: "Dentist", office: "Tokyo", age: 37, startdate: "2009/08/19", salary: "$139,575" },
    { name: "Thor Walton", position: "General Checkup", office: "New York", age: 61, startdate: "2013/08/11", salary: "$98,540" },
    { name: "Finn Camacho", position: "Dentist", office: "San Francisco", age: 47, startdate: "2009/07/07", salary: "$87,500" },
    { name: "Serge Baldwin", position: "Data Coordinator", office: "Singapore", age: 64, startdate: "2012/04/09", salary: "$138,575" },
    { name: "Zenaida Frank", position: "Cardiologist", office: "New York", age: 63, startdate: "2010/01/04", salary: "$125,250" },
    { name: "Zorita Serrano", position: "Cardiologist", office: "San Francisco", age: 56, startdate: "2012/06/01", salary: "$115,000" },
    { name: "Jennifer Acosta", position: "Fertility Specialist", office: "Edinburgh", age: 43, startdate: "2013/02/01", salary: "$75,650" },
    { name: "Cara Stevens", position: "Eye Specialist", office: "New York", age: 46, startdate: "2011/12/06", salary: "$145,600" },
    ...
    { name: "Jonas Alexander", position: "General Checkup", office: "San Francisco", age: 30, startdate: "2010/07/14", salary: "$86,500" },
    { name: "Shad Decker", position: "Regional Director", office: "Edinburgh", age: 51, startdate: "2008/11/13", salary: "$183,000" },
    { name: "Michael Bruce", position: "Fertility Specialist", office: "Singapore", age: 29, startdate: "2011/06/27", salary: "$183,000" },
                ...
                <Row>
                    <Col sm="12">
                            ...
                            <Card.Body>
                                ...
                                <div className="table-responsive">
                                    <div className="mb-3">
                                        Toggle column:{" "}
                                        <Link
                                            className="toggle-vis btn btn-outline-primary mb-1"
                                            data-column="0"
                                        >
                                            Name
                                        </Link>{" "}
                        ...
                        <Card>
                            <Card.Header>
                                <Card.Header.Title >
                                    <h4 className="card-tile mb-0">Input Search Datatable</h4>
                                </Card.Header.Title>
                            </Card.Header>
                            <Card.Body>
                                <p className="mb-3">
                                ...
                                <div className="table-responsive">
                                    ...
                                    <table
                                        ref={inputTableRef}
                                        className="table dataTable my-3"
                                        data-toggle="data-table"
                                    >
                                    </table>
                                </div>
                        ...
                        <Card>
                            <Card.Header>
                                <div className="header-title">
                                    <h4 className="card-tile mb-0">Multi-language Datatable</h4>
                                </div>
                            </Card.Header>
                            <Card.Body>
                                <p className="mb-3">
