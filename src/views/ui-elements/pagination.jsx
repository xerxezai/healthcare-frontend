              ...
              <nav aria-label="Page navigation example">
                <ul className="pagination mb-0">
                  <li className="page-item">
                    <Link className="page-link rtl-pageLink-pre" to="#">
                      Previous
                    </Link>
                  </li>
                  <li className="page-item">
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <nav aria-label="...">
                <ul className="pagination">
                  <li className="page-item disabled">
                    <Link className="page-link rtl-pageLink-pre" to="#" tabIndex="-1">
                      Previous
                    </Link>
                  </li>
                  <li className="page-item">
                  ...
                  <li className="page-item">
                    <Link className="page-link rtl-pageLink-next" to="#">
                      Next
                    </Link>
                  </li>
                </ul>
              ...
              <nav aria-label="...">
                <ul className="pagination">
                  <li className="page-item disabled">
                    <span className="page-link rtl-pageLink-pre">Previous</span>
                  </li>
                  <li className="page-item">
                    <Link className="page-link" to="#">
                      1
            ...
            <div className="card-body">
              ...
              <nav aria-label="Page navigation example">
                <ul className="pagination">
                  <li className="page-item">
                    <Link
                      className="page-link border-success bg-success text-white rtl-pageLink-pre rtl-pageLink-pre"
                      to="#"
                    >
                      Previous
                    </Link>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <nav aria-label="Page navigation example">
                <ul className="pagination mb-0">
                  <li className="page-item">
                    <Link className="page-link rtl-pageLink-pre" to="#" aria-label="Previous">
                  ...
                  <li className="page-item">
                    <Link className="page-link rtl-pageLink-next" to="#" aria-label="Next">
