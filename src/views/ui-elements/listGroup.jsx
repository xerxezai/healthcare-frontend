        ...
        <Col sm="12" lg="6">
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <ListGroup>
                <ListGroup.Item className="list-group-item d-flex justify-content-between align-items-center bg-primary-subtle iq-bg-primary">
                  Cras justo odio
                  <span className="badge bg-primary badge-pill">14</span>
                </ListGroup.Item>
                <ListGroup.Item className="list-group-item d-flex justify-content-between align-items-center bg-success-subtle iq-bg-success">
                  Dapibus ac facilisis in
                  <span className="badge bg-success badge-pill">2</span>
                </ListGroup.Item>
                <ListGroup.Item className="d-flex justify-content-between align-items-center bg-danger-subtle">
                  Morbi leo risus
                  <span className="badge bg-danger badge-pill">1</span>
                </ListGroup.Item>
              </ListGroup>
