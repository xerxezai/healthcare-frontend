            ...
            <Row className="justify-content-center">
                <Col lg={6}>
                    <Card>
                        ...
                        <Card.Body>
                            <div className="timeline0 m-0 d-flex align-items-center justify-content-between position-relative">
                                <ul className="list-inline p-0 m-0">
                                    <li>
                                        <div className="timeline-dots1 border-primary text-primary d-flex justify-content-center">
                                        ...
                                        <small className="float-right mt-1">24 November
                                            2019</small>
                                        <div className="d-inline-block w-100">
                                            <p>Bonbon macaroon jelly beans gummi bears jelly
                                                lollipop apple</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="timeline-dots1 border-success text-success d-flex justify-content-center">
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                        ...
                                        <h6 className="float-left mb-1">Scheduled
                                            Maintenance</h6>
                                        <small className="float-right mt-1">23 November
                                            2019</small>
                                        <div className="d-inline-block w-100">
                                            <p>Bonbon macaroon jelly beans gummi bears jelly
                                                lollipop apple</p>
                                    ...
                                    <li>
                                        <div className="timeline-dots1 border-danger text-danger d-flex justify-content-center">
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                        ...
                                        <small className="float-right mt-1">20 November
                                            2019</small>
                                        <div className="d-inline-block w-100">
                                            <p>Bonbon macaroon jelly beans <a href="#">gummi
                                                bears</a> gummi bears jelly lollipop
                                                apple</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <small className="float-right mt-1">19 November
                                            2019</small>
                                        <div className="d-inline-block w-100">
                                            <p>Bonbon macaroon jelly beans gummi bears jelly
                                                lollipop apple</p>
                                    ...
                                    <li>
                                        <div className="timeline-dots1 border-warning text-warning d-flex justify-content-center">
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                        ...
                                        <small className="float-right mt-1">15 November
                                            2019</small>
                                        <div className="d-inline-block w-100">
                                            <p>Bonbon macaroon jelly beans gummi bears jelly
                                                lollipop apple</p>
                ...
                <Col lg={6}>
                    <Card>
                        <Card.Header className="d-flex justify-content-between ">
                            <Card.Header.Title>
                                <h4 className="card-title">Small Dots Timeline</h4>
                            </Card.Header.Title>
                        </Card.Header>
                        <Card.Body>
